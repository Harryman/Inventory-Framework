...
class Document extends \libs\Model {
    ...
    function insert($id){
           $st = $this->db->prepare("INSERT INTO `document`(`doc_id`, `namespace`, `description`) VALUES (:doc_id,:namespace,:description) ON DUPLICATE KEY UPDATE `namespace` = VALUES(`namespace`), `description` = VALUES(`description`)");
